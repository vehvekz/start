...
$phone = $_POST['phone'];
$total = $_POST['total'];
$smstext = "Заказ споры грибов от ".$name." тел: ".$phone." сум: ".$total;
$goods = $_POST['goods'];
$tr = '';
...
$subject = 'Заявка на споры грибов';
...
if($mail)
{
	...
	$user = 'alexi_el@inbox.ru';            // логин указанный при регистрации или логин api-аккаунта http://littlesms.ru/my/settings/api
